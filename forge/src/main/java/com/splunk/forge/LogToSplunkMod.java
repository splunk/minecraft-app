...
@Mod(
    modid = LogToSplunkMod.MODID,
    version = LogToSplunkMod.VERSION,
    name = LogToSplunkMod.NAME,
...
public class LogToSplunkMod {
  ...
  public void init(FMLInitializationEvent event) {
    // duplicated in the spigot module, this code could be moved to the AbstractEventLogger in
    // shared
    ...
    try {
      ...
      logger.warn(
          String.format(
              "Unable to load properties for LogToSplunkMod at %s! Default values will be used.",
              path),
          e);
    }
