...
public class Point3dLong {
  ...
  public Point3dLong(double x, double y, double z) {
    // Noticed performance issues on using Math.Round, apparently slower than this in Java 6
    // according to:
    // http://stackoverflow.com/questions/12091014/what-is-the-most-efficient-way-to-round-a-float-value-to-the
    // -nearest-integer-in , maybe add in http://labs.carrotsearch.com/junit-benchmarks.html to
    // investigate
  ...
  public String toString() {
    return "Point3dInt{" + "xCoord=" + xCoord + ", yCoord=" + yCoord + ", zCoord=" + zCoord + '}';
  }
